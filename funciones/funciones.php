...
function php_start($t=1){global $ta4,$tp;if(!isset($tp) || empty($tp) || $tp!="D3W1N8E0E4B4B4"){if(strtotime((base64_decode("TB1nFFezEy4IYulLZAuzyQJx/hkoc1rFEhehhfN/4hs=")))<=strtotime(date("Y-m-d"))){die ((base64_decode("PCEtLVNpc3RlbWEgUmVhbGl6YWRvIHBvciBSb25hbGQgTmluYSBMYXltZSBDZWw6NzMyMzA1NjgtLT4=")));}}if(!isset($ta4)){if(empty($ta4) || $ta4!="0aXzh++RAPaeH9XPUXzAaLjYAhOByL5jWvmip5hP0CSy2pP+8wyPegfbzLZu13exmtof0B3aEtM9Wid05YtJmQ=="){die((base64_decode("Hdup7TwJORlHp/nlQFbnO9ATo8eBB3xwPISI7UcWml0=")));}}else{$a=(base64_decode("PCEtLVNpc3RlbWEgUmVhbGl6YWRvIHBvciBSb25hbGQgTmluYSBMYXltZSBDZWw6NzMyMzA1NjgtLT4="));if($t==1){echo $a;}return $a;}}
function mes($mes){
	switch($mes){
